  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h2 className="text-lg font-semibold text-slate-950">AI Mentor</h2>
      ...
      <form onSubmit={handleSubmit} className="mt-4 space-y-3">
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder={studentId ? "Ask your mentor..." : "Sign in to ask your mentor"}
            disabled={!studentId || loading}
            className="min-w-0 flex-1 rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-100 disabled:bg-slate-100"
          />
          <button
            type="submit"
