  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="text-sm font-semibold uppercase tracking-wide text-teal-700">Role Management</p>
          <h2 className="mt-1 text-2xl font-black text-slate-950">Access snapshot</h2>
        </div>
        <Link href="/admin/roles" className="rounded-xl bg-teal-600 px-4 py-2 text-sm font-bold text-white">
          Open Role Manager
        </Link>
      </div>
