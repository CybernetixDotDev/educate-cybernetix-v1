    ...
    <article className="space-y-8">
      ...
      {sections.length > 0 && (
        <div className="space-y-5">
          <div>
            <p className="text-sm font-bold uppercase tracking-wide text-teal-700">Build it one small step at a time</p>
            <h2 className="mt-1 text-3xl font-black text-slate-950">What you need to know</h2>
          </div>
