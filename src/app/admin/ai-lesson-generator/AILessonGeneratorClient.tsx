...
import { renderLessonMp4 } from "@/lib/lesson-studio/renderLessonMp4";
import { saveLessonBlueprint } from "@/lib/lesson-studio/saveLessonBlueprint";
import type { LessonBlueprintSummary, LessonBrief, LessonGeneratorOutput, LessonRender, LessonStoryboard } from "@/lib/lesson-studio/types";
...
const DEFAULT_BRIEF: LessonBrief = {
  ...
  final_project_submission_requirements: {
    ...
    ai_mentor_feedback_rules: [
      ...
      "Unlock the next co-op only when completion criteria are met",
    ],
  },
  required_tools: [],
...
function withBriefDefaults(brief: LessonBrief): LessonBrief {
  return {
    ...
    hands_on_task_requirements: brief.hands_on_task_requirements ?? [],
...
export function AILessonGeneratorClient({ blueprints }: AILessonGeneratorClientProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <RenderPipelinePanel render={render} />
      <ReviewPublishPanel
        lesson={lesson}
