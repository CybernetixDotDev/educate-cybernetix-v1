    ...
    <main className="min-h-screen bg-[#f7faf9] px-4 py-6 text-slate-950 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl space-y-7">
        <header className="rounded-3xl border border-teal-100 bg-white p-7 shadow-sm sm:p-9">
          <div className="grid gap-6 lg:grid-cols-[1fr_13rem] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
                {MENTOR_IDENTITY.name} turns your project idea into tiny tasks, helps when code breaks, and keeps the mission moving.
              </p>
            ...
            <div className="hidden justify-center lg:flex">
              <div className="flex h-48 w-48 items-center justify-center rounded-[2rem] bg-teal-50 ring-1 ring-teal-100">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={MENTOR_IDENTITY.poses.pointing} alt="Zylo" className="h-full w-full object-contain p-3" />
              </div>
            </div>
          </div>
          <Link
